package com.example.ardunio_app;
...
public class MainActivity extends AppCompatActivity {
            ...
            public void handleMessage(Message msg) {
                switch (msg.what) {
                    ...
                    case ERROR_READ:
                       ...
                       // Toast.makeText(getApplicationContext(),arduinoMsg.toString(),Toast.LENGTH_LONG).show();
                        break;
                }
        ...
        final Observable<String> connectToBTObservable = Observable.create(emitter -> {
            ...
            if (connectThread.getMmSocket().isConnected()) {
                ...
                if(connectedThread.getValueRead()!=null)
                {
                    ...
                    //Toast.makeText(getApplicationContext(),connectedThread.getValueRead().toString(),Toast.LENGTH_LONG).show();
                }
                ...
                if (arduinoBTModule != null) {
                    ...
                    connectToBTObservable.
                            ...
                            subscribe(valueRead -> {
                                ...
                                if(valueRead.contains("One"))
                                {
                                    Toast.makeText(getApplicationContext(),valueRead.toString(),Toast.LENGTH_LONG).show();
                                    img.setImageResource(R.drawable.red);
                                } else if (valueRead.contains("Two")) {

                                    Toast.makeText(getApplicationContext(),valueRead.toString(),Toast.LENGTH_LONG).show();
                                    img2.setImageResource(R.drawable.red);
                                }
                                else if (valueRead.contains("Three")) {

                                    Toast.makeText(getApplicationContext(),valueRead.toString(),Toast.LENGTH_LONG).show();
                                    img3.setImageResource(R.drawable.red);
                                }
                                else if (valueRead.contains("Four")) {
    ...
    private void sharedata(String valueRead) {




        if(valueRead.equals("one"))
        {
            Toast.makeText(getApplicationContext(),valueRead,Toast.LENGTH_LONG).show();
            img.setImageResource(R.drawable.red);
